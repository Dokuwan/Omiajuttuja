...
class Tpcatalog_Widget extends WP_Widget {
    ...
    public function form($instance){
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_id('title')); ?>" value="<?php echo esc_attr($title); ?>">
...
<?php
    ...
    public function update($new_instance, $old_instance){
        ...
        $instance["title"] = isset($new_instance["title"]) ? wp_strip_all_tags($new_instance["title"]) : "Päivän lahjoituskohde";
